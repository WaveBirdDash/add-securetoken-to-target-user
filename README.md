...
- `sysadminctl` SecureToken syntax discovered and formalized in [Mac Admins](https://macadmins.org) Slack `#filevault`.

## License

This project is offered under an [MIT License](LICENSE.md).
